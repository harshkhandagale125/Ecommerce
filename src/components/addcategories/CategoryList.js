...
const CategoryTable = () => {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "flex-start", marginBottom: "20px", marginLeft: "700px" }}>
        <Button variant="contained" color="primary" component={Link} to="/addcategory">
          Add New Category
        </Button>
      </div>
      <div className="table">
